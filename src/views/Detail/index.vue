          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spu, index) in spuSaleAttrList" :key="spu.id">
                ...
                <dd
                  changepirce="0"
                  :class="{ active: spucolor.isChecked == 1 }"
                  v-for="(spucolor, index) in spu.spuSaleAttrValueList"
                  :key="spucolor.id"
                  @click="change(spucolor, spu.spuSaleAttrValueList)"
                >
                  {{ spucolor.saleAttrValueName }}
                </dd>
              </dl>
            </div>
            <div class="cartWrap">
...
export default {
  ...
  mounted() {
    this.$store.dispatch("reqgoodsinfo", this.$route.params.skuid);
  },
  methods: {
    change(spucolor, arr) {
      arr.forEach((element) => {
